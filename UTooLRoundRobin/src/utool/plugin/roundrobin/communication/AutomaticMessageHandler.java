...
public class AutomaticMessageHandler 
{
	...
	{     
		RoundRobinTournament t = (RoundRobinTournament) TournamentContainer.getInstance(tid);
		String message = RoundRobinOptionsTabActivity.getTournamentDataText(t);
		try
		{
	...
	class RetreiveFeedTask extends AsyncTask<String, Void, String> {
		...
		protected String doInBackground(String... urls) {
			...
			try {   
				...
				String subject = t.getTournamentName()+": Tournament Matches up to Round "+(((RoundRobinTournament)t).getRounds().size());
				String body = RoundRobinOptionsTabActivity.getTournamentData((RoundRobinTournament) TournamentContainer.getInstance(tid));
